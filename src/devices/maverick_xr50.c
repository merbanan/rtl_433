...
static int maverick_xr50_decode(r_device *decoder, bitbuffer_t *bitbuffer)
{
   ...
   data_t *data = data_make(
        ...
        "temperature_high_1_C", "Temperature 1 alarm high", DATA_FORMAT, "%.1f C", DATA_DOUBLE, p1_set_high,
        "temperature_low_1_C",  "Temperature 1 alarm low",  DATA_FORMAT, "%.1f C", DATA_DOUBLE, p1_set_low,
        ...
        "temperature_high_2_C", "Temperature 2 alarm high", DATA_FORMAT, "%.1f C", DATA_DOUBLE, p2_set_high,
        "temperature_low_2_C",  "Temperature 2 alarm low",  DATA_FORMAT, "%.1f C", DATA_DOUBLE, p2_set_low,
        ...
        "temperature_high_3_C", "Temperature 3 alarm high", DATA_FORMAT, "%.1f C", DATA_DOUBLE, p3_set_high,
        "temperature_low_3_C",  "Temperature 3 alarm low",  DATA_FORMAT, "%.1f C", DATA_DOUBLE, p3_set_low,
        ...
        "temperature_high_4_C", "Temperature 4 alarm high", DATA_FORMAT, "%.1f C", DATA_DOUBLE, p4_set_high,
        "temperature_low_4_C",  "Temperature 4 alarm low",  DATA_FORMAT, "%.1f C", DATA_DOUBLE, p4_set_low,
