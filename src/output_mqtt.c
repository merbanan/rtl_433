...
R_API_CALLCONV static void print_mqtt_array(data_output_t *output, data_array_t *array, char const *format)
{
...
R_API_CALLCONV static void print_mqtt_data(data_output_t *output, data_t *data, char const *format)
{
    UNUSED(format);
    data_output_mqtt_t *mqtt = (data_output_mqtt_t *)output;
...
R_API_CALLCONV static void print_mqtt_string(data_output_t *output, char const *str, char const *format)
{
    UNUSED(format);
    data_output_mqtt_t *mqtt = (data_output_mqtt_t *)output;
...
R_API_CALLCONV static void print_mqtt_double(data_output_t *output, double data, char const *format)
{
    char str[20];
...
R_API_CALLCONV static void print_mqtt_int(data_output_t *output, int data, char const *format)
{
    char str[20];
...
R_API_CALLCONV static void data_output_mqtt_free(data_output_t *output)
{
    data_output_mqtt_t *mqtt = (data_output_mqtt_t *)output;
