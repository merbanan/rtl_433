/** @file
    ...
    Copyright (C) 2022 Jan Schmidt <JanSchmidt3@users.noreply.github.com>
 ...
 */
static int ws2000_combo_callback(r_device *decoder, bitbuffer_t *bitbuffer)
{
    data_t *data;
    ...
    data = data_make(
            ...
            //KS200 / KS300
            "wind_avg_km_h",    "", DATA_FORMAT, "%.1f kmh", DATA_DOUBLE, (double)wind,
            "rain_count",       "", DATA_FORMAT, "%d", DATA_INT, rainsum,
            "rain_mm",          "", DATA_FORMAT, "%.1f", DATA_DOUBLE, (double)rainsum * 0.295,
            "is_raining",       "", DATA_FORMAT, "%d", DATA_INT, it_rains,
            "unknown",          "", DATA_FORMAT, "%d", DATA_INT, unknown,
            NULL);
    /* clang-format on */
...
static char *elv_ws2000_combo_output_fields[] = {
        "model",
        "id",
        "subtype",
        "temperature_C",
...
r_device elv_ws2000_combo = {
        ...
        .decode_fn   = &ws2000_combo_callback,
        .disabled    = 0,
        .fields      = elv_ws2000_combo_output_fields,
};
