...
void data_acquired_handler(r_device *r_dev, data_t *data) {
        ...
        if (cfg->report_meta && cfg->demod->fsk_pulse_data.fsk_f2_est) {
                data_append(data,
                            ...
                            "freq1", "Freq1", DATA_FORMAT, "%.1f MHz", DATA_DOUBLE,
                            cfg->demod->fsk_pulse_data.freq1_hz / 1000000.0,
                            "freq2", "Freq2", DATA_FORMAT, "%.1f MHz", DATA_DOUBLE,
                            cfg->demod->fsk_pulse_data.freq2_hz / 1000000.0,
                ...
                data_append(data,
                            ...
                            "freq", "Freq", DATA_FORMAT, "%.1f MHz", DATA_DOUBLE,
                            cfg->demod->pulse_data.freq1_hz / 1000000.0,
