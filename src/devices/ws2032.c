...
static int fineoffset_ws2032_decode(r_device *decoder, bitbuffer_t *bitbuffer)
{
    ...
    data = data_make(
            ...
            _X("wind_dir_deg","direction_deg"),     "Wind Direction",    DATA_FORMAT, "%.01f",   DATA_FLOAT, dir,
            "wind_avg_km_h",    "Wind avg speed",   DATA_FORMAT, "%.01f",   DATA_FLOAT, speed,
            "wind_max_km_h",    "Wind gust",        DATA_FORMAT, "%.01f",   DATA_FLOAT, gust,
