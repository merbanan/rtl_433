...
/// Demodulate a Return-to-Zero inverted (RZI) coded signal.
///
...
/// same way).
///
/// Note this is the opposite of this project's usual OOK convention of
/// low energy/long = 0, high energy/short = 1: here the *short* interval
/// (the dip) is the 0-bit, and *long* (a whole high run) is one or more
/// 1-bits. This is also an unusual, inefficient coding: an OOK_PULSE_PWM
/// or OOK_PULSE_PPM signal with the same bit rate would need far less
