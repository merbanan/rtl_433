...
static int esic_emt7110_decode(r_device *decoder, bitbuffer_t *bitbuffer)
{
    ...
    data = data_make(
            ...
            "power_W",      "Power",        DATA_FORMAT, "%.1f W",   DATA_FLOAT, power_w,
            "current_A",    "Current",      DATA_FORMAT, "%.3f A",   DATA_FLOAT, current_a,
            "voltage_V",    "Voltage",      DATA_FORMAT, "%.1f V",   DATA_FLOAT, voltage_v,
            "energy_kWh",   "Energy",       DATA_FORMAT, "%.2f kWh", DATA_FLOAT, energy_kwh,
