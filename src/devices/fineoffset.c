...
static int fineoffset_WH51_callback(r_device *decoder, bitbuffer_t *bitbuffer)
{
     ...
     *   1200   0%
     *
     * To deal with other chemistries, we map greater than 1600 to
     * 100% and anything lower to 0%.
     */
    switch (battery_mv_bits) {
    case 15: battery_level = 0.90; break;
    case 14: battery_level = 0.50; break;
    case 13: battery_level = 0.10; break;
    case 12: battery_level = 0.0; break;
    default:
