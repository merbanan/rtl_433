...
static void pulse_detect_fsk_minmax_impl(pulse_detect_fsk_t *s, int16_t const *fm_data, int count,
        pulse_data_t *fsk_pulses, int use_hysteresis, int use_decay, int use_median)
{
    for (int i = 0; i < count; ++i) {
    int16_t fm_n = fm_data[i];
    int16_t mid  = 0;
...
{
    pulse_detect_fsk_minmax_impl(s, fm_data, count, fsk_pulses, 0, 1, 0);
}

void pulse_detect_fsk_minmax_hysteresis(pulse_detect_fsk_t *s, int16_t const *fm_data, int count, pulse_data_t *fsk_pulses)
{
    pulse_detect_fsk_minmax_impl(s, fm_data, count, fsk_pulses, 1, 1, 0);
}

void pulse_detect_fsk_minmax_median(pulse_detect_fsk_t *s, int16_t const *fm_data, int count, pulse_data_t *fsk_pulses)
{
    pulse_detect_fsk_minmax_impl(s, fm_data, count, fsk_pulses, 0, 0, 1);
}
