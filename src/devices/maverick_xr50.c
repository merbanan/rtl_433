...
static int maverick_xr50_decode(r_device *decoder, bitbuffer_t *bitbuffer)
{
    ...
    int p1_set_high = (p_1_high_raw - 500) / 10;
    int p1_set_low  = (p_1_low_raw - 500) / 10;

    float p2_temp     = (p_2_temp_raw - 500) * 0.1f;
    int p2_set_high = (p_2_high_raw - 500) / 10;
    int p2_set_low  = (p_2_low_raw - 500) / 10;

    float p3_temp     = (p_3_temp_raw - 500) * 0.1f;
    int p3_set_high = (p_3_high_raw - 500) / 10;
    int p3_set_low  = (p_3_low_raw - 500) / 10;

    float p4_temp     = (p_4_temp_raw - 500) * 0.1f;
    int p4_set_high = (p_4_high_raw - 500) / 10;
    int p4_set_low  = (p_4_low_raw - 500) / 10;
   ...
   data_t *data = data_make(
        ...
        "temperature_high_1_C", "Temperature 1 alarm high", DATA_INT, p1_set_high,
        "temperature_low_1_C",  "Temperature 1 alarm low",  DATA_INT, p1_set_low,
        ...
        "temperature_high_2_C", "Temperature 2 alarm high", DATA_INT, p2_set_high,
        "temperature_low_2_C",  "Temperature 2 alarm low",  DATA_INT, p2_set_low,
        ...
        "temperature_high_3_C", "Temperature 3 alarm high", DATA_INT, p3_set_high,
        "temperature_low_3_C",  "Temperature 3 alarm low",  DATA_INT, p3_set_low,
        ...
        "temperature_high_4_C", "Temperature 4 alarm high", DATA_INT, p4_set_high,
        "temperature_low_4_C",  "Temperature 4 alarm low",  DATA_INT, p4_set_low,
...
static char const *const output_fields[] = {
    ...
    "probe_1_flags",
    "temperature_1_C",
    "temperature_high_1_C",
    "temperature_low_1_C",
    "probe_2_flags",
    "temperature_2_C",
    "temperature_high_2_C",
    "temperature_low_2_C",
    "probe_3_flags",
    "temperature_3_C",
    "temperature_high_3_C",
    "temperature_low_3_C",
    "probe_4_flags",
    "temperature_4_C",
    "temperature_high_4_C",
    "temperature_low_4_C",
    "mic",
    NULL,
};
...
r_device const maverick_xr50 = {
    .name        = "Maverick XR-50 BBQ Sensor",  // Nome del nuovo modello
    .modulation  = FSK_PULSE_PCM,
    .short_width = 107,
    .long_width  = 107,
    .reset_limit = 2200,
    .decode_fn   = &maverick_xr50_decode,  // Collegamento alla nuova funzione di decodifica
