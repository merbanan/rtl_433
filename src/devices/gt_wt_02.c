...
//        /* @todo: remove timestamp printing as soon as the controller takes this task */
...

   {
    ...
    data = data_make(
                     ...
                     "model","",DATA_STRING,"GT-WT-02 Sensor",
                     "id","ID",DATA_INT,sensor_id,
                     "channel","Channel",DATA_INT,channel+1,
                     "battery","Battery",DATA_STRING,battery_low ? "LOW": "OK",
                     "button","Button",DATA_INT,button_pressed,
                     "temperature_C","Temperature",DATA_FORMAT, "%.2f C",DATA_DOUBLE,tempC,
                     "humidity","Humidity",DATA_FORMAT,humidity_str,
                     NULL);
...

{
    ...
    {
        {0x00, 0x00, 0x00, 0x00, 0x00}, // this one is excluded despite the correct checksu
